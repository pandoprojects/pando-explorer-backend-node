...
exports.getGcpByHeight = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'pando.GetGcpByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
}
exports.getRametronenterprisepByHeight = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'pando.GetRametronenterprisepByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
...
exports.getPendingTxs = function (params, callback){
  body = {
    jsonrpc: '2.0',
    method: 'pando.GetPendingTransactions',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
...
exports.getStakeRewardDistribution = function (params, callback) {
  body = {
    jsonrpc: '2.0',
    method: 'pando.GetStakeRewardDistributionByHeight',
    params: params,
    id: RandomIdGenerator()
  }
  ProcessHttpRequest(config.node.address, config.node.port, 'POST', '/rpc', JSON.stringify(body), callback);
