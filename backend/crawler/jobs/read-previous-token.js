...
var { decodeLogs, checkPNC721, checkPNC20, checkAndInsertToken } = require('../helper/smart-contract');
  ...
  for (let tx of txs) {
    ...
    for (let address of addressList) {
      ...
      if (!abi) {
        ...
        infoMap[address].type = checkPNC721(abi) ? 'PNC-721' : checkPNC20(abi) ? 'PNC-20' : 'unknown';
