...
const TxType = {
    TxTypeCoinbase: 0,
    TxTypeSlash: 1,
    TxTypeSend: 2, // for transfer
    TxTypeReserveFund: 3,
    TxTypeReleaseFund: 4,
    TxTypeServicePayment: 5,
    TxTypeSplitRule: 6,
    TxTypeSmartContract: 7,
    TxTypeDepositStake: 8, // for zetatron
    TxTypeWithdrawStake: 9, // for both withdraw zeta and meta
    TxTypeDepositStakeV2: 10, // for metatron

    // TxTypeReserveFund: 3,
    // TxTypeReleaseFund: 4,
    // TxTypeServicePayment: 5,
    // TxTypeSplitRule: 6,
    // TxTypeSmartContract: 8,
    // TxTypeDepositStake: 9,
    // TxTypeWithdrawStake: 10,
    // TxTypeDepositStakeV2: 11,
};
