...
exports.updateTokenHistoryBySmartContract = async function (sc, transactionDao, accountTxDao, tokenDao, tokenSummaryDao, tokenHolderDao) {
  ...
  if (tokenName === "" && isPNC721) {
    try {
      ...
      console.log('Error in fetch PNC-721 token name by tokenURI in updateTokenHistoryBySmartContract: ', e.message);
    }
