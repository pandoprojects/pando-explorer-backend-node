...
The **Pando Explorer APIs** is provided by the Pando Explorer Microservice Node. It is the REST interface via which a user can interact with the Pando Explorer Microservice Node directly. 

## Table of Contents

- [Pando Explorer APIs](#pando-explorer-apis)
   ...
   - [Supply APIs](#supply-apis)
		- [GetPandoAmount](#getpandoamount)
      - [GetPTXAmount](#getPTXamount)
...
- tokenType: type of the token(pando/PTX)
...
- stakes: json representation of the stakes
   ...
   - amount: the staked PandoWei amount 
...
- totalAmount: the total amount of staked PandoWei
...
This API returns the total amount and circulation amount of Pando.

**REST Uri**: /supply/pando

**Returns**

- total_supply: the total amount of pando supplied
- circulation_supply: the circulation amount of pando supplied
...
This API returns the circulation amount of PTX.

**REST Uri**: /supply/PTX

**Returns**

- circulation_supply: the circulation amount of PTX supplied
